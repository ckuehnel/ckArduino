 /* File: Beetle_ESP32-C3_Battery_Monitor.ino
 *  
...
#define LED_BUILTIN 10  // Green LED at GPIO3 on T-OI plus ESP32-C3
...
void setup()
{
  ...
  if (DEBUG) Serial.println("Starting Beetle_ESP32-C3...");
