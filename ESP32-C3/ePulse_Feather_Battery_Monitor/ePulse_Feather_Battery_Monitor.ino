 /* File: ePulse_Feather_Battery_Monitor.ino
 *  
...
// Data point
Point sensor("Voltaic Battery_Voltage");

#define BAT_ADC   34  // Voltage divider for ADC Input on ESP32-C3-DevKitC
...
void setup()
{
  ...
  if (DEBUG) Serial.println("Starting ePulse_Feather_Battery_Monitor...");
